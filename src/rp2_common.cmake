...
function(pico_add_hex_output TARGET)
    if (CMAKE_C_COMPILER_ID STREQUAL "ARMClang")
        add_custom_command(TARGET ${TARGET} POST_BUILD COMMAND ${CMAKE_OBJCOPY} --i32 $<TARGET_FILE:${TARGET}> --output $<IF:$<BOOL:$<TARGET_PROPERTY:${TARGET},OUTPUT_NAME>>,$<TARGET_PROPERTY:${TARGET},OUTPUT_NAME>,$<TARGET_PROPERTY:${TARGET},NAME>>.hex)
    else ()
...
function(pico_add_bin_output TARGET)
    if (CMAKE_C_COMPILER_ID STREQUAL "ARMClang")
        add_custom_command(TARGET ${TARGET} POST_BUILD COMMAND ${CMAKE_OBJCOPY} --bin $<TARGET_FILE:${TARGET}> --output $<IF:$<BOOL:$<TARGET_PROPERTY:${TARGET},OUTPUT_NAME>>,$<TARGET_PROPERTY:${TARGET},OUTPUT_NAME>,$<TARGET_PROPERTY:${TARGET},NAME>>.bin)
    else ()
