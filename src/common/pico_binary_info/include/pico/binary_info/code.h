...
#if !PICO_NO_BINARY_INFO
#define __bi_decl(name, bi, section_prefix, attr) static const attr __attribute__((used, section(section_prefix __STRING(name)))) struct _binary_info_core *const name = bi
